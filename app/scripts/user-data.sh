...
GITHUB_REPO="https://github.com/mohamedmabrouk-666/Employee-Job-Application-Cloud-System"
...
"$REPO_DIR/venv/bin/pip" install -r "$REPO_DIR/app/requirements.txt"
